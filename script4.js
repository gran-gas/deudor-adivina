...
var numSecret = Math.round(Math.random()*1000);  // Numero a ser adivinado por el usuario

console.log(numSecret);

var lifes = 4; // intentos 
...
document.getElementById("submitter").onclick = function (){
    ...
    if (userGuess == numSecret){
        ...
        document.getElementById("title").onclick = function (){
            ...
            window.location.replace("./impossible.html");
        ...
        if (numSecret > userGuess){
            ...
            else if ((numSecret - userGuess) <= 500){


                score = score + (lifes * 50);
            }

            else if ((numSecret - userGuess) <= 1000){
